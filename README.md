...
* **Python (Konsep Dasar):** Menggunakan fungsi matematika, perulangan (*looping*), fungsi kustom (*function*), dan pemrograman berorientasi objek (*Class & Object*)[cite: 3].
* **Pandas:** Melakukan pembacaan dataset transaksi format `.csv` menggunakan fungsi `read_csv()` dan menampilkan sampel data[cite: 3].
* **NumPy:** Digunakan untuk perhitungan statistik numerik mendasar secara cepat[cite: 3].
* **Matplotlib:** Membuat visualisasi grafik batang untuk performa produk[cite: 3].
...
## 📊 Hasil Visualisasi & Kesimpulan
* Berdasarkan grafik batang yang dihasilkan, produk **Mouse** menempati posisi dengan total penjualan tertinggi, disusul oleh produk Laptop dan Keyboard[cite: 3].
* Melalui proyek ini, fondasi dasar manipulasi data menggunakan ekosistem Python berhasil diterapkan untuk menganalisis laporan penjualan toko[cite: 3].
